...
(() => {
  ...
  const TASK_TAGS = new Map([
    ...
    ["ToasterOvenBroilFish", ["pnp", "rack_slide", "knob_twist", "toaster_oven_close"]],
    ...
    ["HeatKebabSandwich", ["pnp", "knob_twist", "rack_slide", "toaster_oven_close"]],
    ["HotDogSetup", ["pnp", "door_open"]],
    ["PrepareSausageCheese", ["pnp", "door_open"]],
    ["ToastHeatableIngredients", ["pnp", "rack_slide", "toaster_oven_open"]],
    ...
    ["ServeWarmCroissant", ["pnp", "rack_slide", "toaster_oven_open"]],
    ["ToastBagel", ["pnp", "rack_slide", "knob_twist", "toaster_oven_close"]],
    ["ToastBaguette", ["pnp", "rack_slide", "knob_twist", "toaster_oven_close"]],
    ["ToastOnCorrectRack", ["pnp", "rack_slide", "toaster_oven_open"]],
  ...
  const TASK_TAG_REMOVALS = new Map([
    ...
    ["HeatKebabSandwich", ["door_close"]],
    ["ToastHeatableIngredients", ["door_open"]],
    ["ServeWarmCroissant", ["door_open"]],
    ...
    ["ToastBagel", ["door_close"]],
    ["ToastOnCorrectRack", ["door_open"]],
    ["ToasterOvenBroilFish", ["door_close"]],
    ["ToastBaguette", ["door_close"]],
  ...
  function renderCompositeStarIntoTaskCell(taskName, taskTd) {
    ...
    star.className = `rc-comp-star ${isSeen ? "rc-comp-star-seen" : "rc-comp-star-unseen"}`;
    star.textContent = "*";
    star.dataset.label = isSeen ? "Composite Seen" : "Composite Unseen";
  ...
  function renderTaskTagsIntoCell(taskName, containerTd, navigationVal, descText) {
    ...
    function pillForTag(t) {
      ...
      // Composite Seen/Unseen is shown as a colored star next to the task name
      ...
      if (t === "toaster_oven_open") {
        span.classList.add("rc-task-tag-toaster-oven-open");
        span.textContent = "Open Toaster Oven";
        return span;
      }
      if (t === "toaster_oven_close") {
        span.classList.add("rc-task-tag-toaster-oven-close");
        span.textContent = "Close Toaster Oven";
        return span;
      }
      if (t === "start_toaster") {
  ...
  function addAttributesToTable(table, attrsMap, episodeLengthMap) {
    ...
    for (const tr of rows) {
      ...
      if (name && taskTd) renderCompositeStarIntoTaskCell(name, taskTd);
  ...
  onReady(() => {
    ...
    const TASK_ATTRS = [
      ...
      { key: "toaster_oven_open", label: "Open Toaster Oven", pillClass: "rc-task-tag rc-task-tag-toaster-oven-open" },
      { key: "toaster_oven_close", label: "Close Toaster Oven", pillClass: "rc-task-tag rc-task-tag-toaster-oven-close" },
  ...
  onReady(() => {
    ...
    (async () => {
      ...
      function stripCompositeStars(table) {
        if (!table) return;
        for (const el of Array.from(table.querySelectorAll(".rc-comp-star"))) el.remove();
      }
      ...
      if (compSeenTable) {
        ...
        stripCompositeStars(compSeenTable);
      }
      ...
      if (compUnseenTable) {
        ...
        stripCompositeStars(compUnseenTable);
      }
    })();
  });
})();
